...
class hidkeyboard:
    ...
    keys = {
        ...
        "í": [0x35], "Í": [k.MOD_LEFT_SHIFT, 0x35],
        ...
        "ű": [0x31], "Ű": [k.MOD_LEFT_SHIFT, 0x31],

        # ---------------- NUMBERS ----------------
        "0": [0x62], "1": [0x1E], "2": [0x1F], "3": [0x20],
        ...
        "'": [0x31], "\\": [k.MOD_LEFT_ALT,   0x2D],
        "+": [0x13], "*": [k.MOD_LEFT_SHIFT, 0x13],
        "<": [0x32], ">": [k.MOD_LEFT_SHIFT, 0x32],
                     ...
                     "÷": [k.MOD_LEFT_ALT | k.MOD_LEFT_SHIFT, 0x37],
        # ---------------- CONTROL CHARACHTERS ----------------
                     "\t":  [0x2B], #TAB
                     "\n":  [0x28], #ENTER
